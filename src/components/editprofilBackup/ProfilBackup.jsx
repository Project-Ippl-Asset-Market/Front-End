  ...
  useEffect(() => {
    if (currentUserId) {
      ...
      const unsubscribe = onSnapshot(q, (snapshot) => {
        ...
        console.log("Pengguna tidak ditemukan,mencoba untuk mencari di collections admins");
        ...
        const unsubscribe = onSnapshot(adminsQuery, (snapshot) => {
          if (!snapshot.empty) {
            ...
            console.log("Profile not found in both collections.");
          }
        })
      }});
