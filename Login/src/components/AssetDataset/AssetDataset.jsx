    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg relative w-[600px] h-[712px]">
        ...
        <div className="relative">
          <img src={asset.image} alt="Asset" className="w-full h-64 object-cover mt-4 mb-4" />
          <p className="absolute bottom-0 right-0 bg-[#D9D9D9A6] opacity-85 font-bold text-black px-3 py-1 rounded-tl-[10px]">{asset.price}</p>
        </div>
...
function AssetDataset() {
  ...
  const assets = [
    ...
    { title: 'Dataset Ombak Laut', description: 'Sore tenang...', price: 'Rp. 30.000,00', image: Dataset },
          ...
          {assets.map((asset, index) => (
            ...
            >
              <div className="flex justify-center">
                <img src={asset.image} alt="Product" className="w-53 h-48 object-cover mb-4" />
              </div>
              <div className="text-sm">
                ...
                <div className="flex justify-between items-center text-gray-600">
                  <span className="flex items-center">
                    <img src={IconLike} className="mr-2 w-5 h-5" alt="Like" /> 2301
                  </span>
