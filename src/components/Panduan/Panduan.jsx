...
import { Link, Routes, Route, useLocation } from 'react-router-dom'; // Import Routes and Route
import DarkMode from '../website/web_User-LandingPage/DarkMode'; // Import DarkMode component
import PanduanRegistrasi from './PanduanRegistrasi'; // Import PanduanRegistrasi
