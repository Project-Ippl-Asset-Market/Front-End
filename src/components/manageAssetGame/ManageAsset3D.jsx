...
function ManageAsset3D() {
  // Ubah nama fungsinya untuk segmen 2D
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (role === "superadmin") {
          ...
          q = query(collection(db, "assetImage3D")); // Ubah ke "assetImage2D"
        } else if (role === "admin") {
        ...
        for (const docSnap of querySnapshot.docs) {
          ...
          items.push({
            ...
            price: `Rp. ${data.price}`,
            asset2DImage: data.asset3DImage, // Ubah asset3DImage menjadi asset2DImage
                  ...
                  {currentDatasets.map((asset) => (
                    <tr
                      ...
                      <td className="px-6 py-4">
                        {asset.asset3DImage ? (
                          <img
                            src={asset.asset3DImage || CustomImage}
                            alt="Image"
