...
function EditAdmin() {
  ...
  //   try {
  //     let profileImageUrl = admin.profileImageUrl;

  //     if (admin.profileImage) {
  //       const imageRef = ref(storage, `images-admin/profileImage-${id}.jpg`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (admin.profileImage) {
        const oldImageRef = ref(storage, `images-admin/profileImage-${id}.jpg`);
