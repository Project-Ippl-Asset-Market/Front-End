...
export function AssetImage() {
  ...
  const [modalMesageBuy, setModalMesageBuy] = useState("");
  ...
  const handleBuyNow = async () => {
    if (!currentUserId) {
      setModalMesageBuy("Anda perlu login untuk membeli asset");
      navigate("/login");
      return;
    }
    ...
    // Tambahkan item ke keranjang tanpa menampilkan notifikasi
