...
const ProductGrid = () => {
  ...
  const products = [
    ...
    {
      id: 2,
      image: "src/assets/assetgame/YSM.png",
      title: "Danger Unknown - Sci-Fi Horror Music Collection",
      author: "Ardiansyah Bin Sangkala",
      price: "Rp. 30.000",
      likes: "100k",
      category: "Music",
    },
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 lg:px-10 py-8">
      <div className="flex flex-wrap items-center space-x-4 space-y-2 mb-4">
        {/* Button 2D */}
