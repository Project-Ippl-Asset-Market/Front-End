...
function EditProfil() {
  ...
  return (
    <div className="dark:bg-neutral-20 text-neutral-10 dark:text-neutral-90 min-h-screen font-poppins bg-primary-100 ">
      ...
      {/* Main Layout */}
      <div className="dark:bg-neutral-20 dark:text-neutral-90 mt-[10%] bg-primary-100 text-black duration-500 flex mb-20">
        {/* Sidebar */}
        ...
        {/* Main Content */}
        <main className="dark:bg-neutral-20 dark:text-neutral-90  lg:w-3/4 p-4 bg-primary-100 rounded-lg ml-6">
          <h1 className="text-3xl font-bold mb-3">Edit Profile</h1>

          <div className="dark:bg-neutral-20 dark:text-neutral-90  bg-primary-100 p-10 rounded-lg shadow-lg mb-4 gap-10">
            {/* Profile Edit Form */}
