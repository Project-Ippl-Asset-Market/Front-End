          ...
          <table className="min-w-full bg-white border rounded-lg">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                ...
                <th className="py-3 px-6 text-left">Berkas</th>{" "}
                {/* Kolom baru untuk berkas */}
              ...
              {withdrawRequests.length > 0 ? (
                withdrawRequests.map((request) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-6">{request.accountNumber}</td>
                    <td className="py-3 px-6">{request.bankName}</td>
                    <td className="py-3 px-6">Rp. {request.amount}</td>
                    <td className="py-3 px-6">{request.status}</td>
                    <td className="py-3 px-6">
                      <button
                        onClick={() => window.open(request.fileUrl, "_blank")} // Akses fileUrl
                        className="bg-blue-500 text-white px-4 py-1 rounded"
                        disabled={!request.fileUrl} // Nonaktifkan jika tidak ada URL
                      >
                        Lihat Berkas
                      </button>
                    </td>
