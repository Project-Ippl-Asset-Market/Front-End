    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col space-y-4 p-4">
          ...
          <Link
            to="/panduanregistrasi"
            className={`text-left text-lg font-medium py-2 px-4 rounded-full ${
              isActive('/panduanregistrasi') ? 'bg-blue-500' : 'hover:bg-gray-800'
            }`}
          >
            Registrasi
          </Link>
          ...
          <Link
            to="/panduanlogin"
            className={`text-left text-lg font-medium py-2 px-4 rounded-full ${
              isActive('/panduanlogin') ? 'bg-blue-500' : 'hover:bg-gray-800'
            }`}
          >
            Login
          </Link>
          ...
          <Link
            to="/panduanlupapassword"
            className={`text-left text-lg font-medium py-2 px-4 rounded-full ${
              isActive('/panduanlupapassword') ? 'bg-blue-500' : 'hover:bg-gray-800'
            }`}
          >
            Lupa Password
          </Link>
          ...
          <Link
            to="/panduanjualaset"
            className={`text-left text-lg font-medium py-2 px-4 rounded-full ${
              isActive('/panduanjualaset') ? 'bg-blue-500' : 'hover:bg-gray-800'
            }`}
          >
            Jual Asset
          </Link>
          ...
          <Link
            to="/panduaneditaset"
            className={`text-left text-lg font-medium py-2 px-4 rounded-full ${
              isActive('/panduaneditaset') ? 'bg-blue-500' : 'hover:bg-gray-800'
            }`}
          >
            Edit Asset
          </Link>
