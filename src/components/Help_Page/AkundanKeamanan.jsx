...
const AkunDanKeamanan = () => {
  ...
  const akunQuestions = [
    { 
      ...
      answer: (
        <ol className="list-decimal pl-6 space-y-2">
          <li>Buka halaman <strong>Pengaturan Akun</strong>.</li>
          <li>Pilih opsi <strong>Ubah Kata Sandi</strong>.</li>
    ...
    { 
      ...
      answer: (
        <ol className="list-decimal pl-6 space-y-2">
          <li>Buka halaman <strong>Lupa Password</strong>.</li>
          <li>Masukkan email Anda dan klik <strong>Kirim</strong>.</li>
      ...
      <main className="bg-gray-100 py-10 px-5">
        <div className="max-w-md mx-auto mt-8">
          <div className="bg-white p-5 rounded-lg shadow-md">
            <h2 className="text-xl font-bold mb-4">Pertanyaan Akun dan Keamanan</h2>
