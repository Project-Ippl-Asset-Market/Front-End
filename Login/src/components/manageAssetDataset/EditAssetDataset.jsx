...
function EditNewDataset() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof datasetImage === 'object' && datasetImage) {
        // Delete the old image if a new image is being uploaded
        const oldImageRef = ref(storage, `images-dataset/datasetImage-${assetId}.jpg`);
        await deleteObject(oldImageRef); // Delete the old image

        // Upload the new image
        const imageRef = ref(storage, `images-dataset/datasetImage-${assetId}.jpg`);
