...
import Photo1 from '../../../assets/assetabout/Photo 1.png';
import Photo2 from '../../../assets/assetabout/Photo 2.png';

// Main LandingPage component
const About = () => {
  // Create a reference to the reviews section
  const reviewsRef = useRef(null);

  // Function to handle scrolling to the reviews section
            ...
            <div className="flex-grow flex justify-center sm:justify-end sm:mt-0">
              <nav className="flex items-center space-x-4 sm:space-x-10 mx-[-10px] ml-4 sm:ml-6 md:ml-8 lg:ml-10 xl:ml-12">
                <ul className="flex space-x-4 text-black font-poppins text-xs">
                  ...
                  <li>
                    <Link to="/asset-gratis" className="hover:text-gray-500">Assets</Link>
                  </li>
                  <li>
                    <button 
                      onClick={scrollToReviews}
                      className="hover:text-gray-500">Testimonials</button>
                  </li>
                </ul>
                ...
                <a
                  href="/"
                  className="bg-[#5282ED] text-xs text-white font-poppins py-1 px-1 sm:px-8 rounded ml-0 sm:ml-5"
                >
                  Go  The  Web →
                </a>
              </nav>
...
const Reviews = ({ reviewsRef }) => {
  return (
    <section ref={reviewsRef} className="bg-[#5282ED] text-white py-16 px-10 w-screen">
