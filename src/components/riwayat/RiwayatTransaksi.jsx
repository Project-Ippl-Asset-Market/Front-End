...
export function RiwayatTransaksi() {
  ...
  return (
    <div className="dark:bg-neutral-20 text-neutral-10 dark:text-neutral-90 font-poppins bg-primary-100">
      <div className="w-full shadow-lg bg-primary-100 dark:text-primary-100 relative z-40">
        <HeaderNav />
        <NavbarSection />
      </div>
      <div className="w-full p-4 md:p-12 mt-20 top-24">
        <h2 className="text-2xl font-semibold mb-4 mt-60 lg:mt-24 text-center -z-40">
          Riwayat Transaksi
        </h2>
