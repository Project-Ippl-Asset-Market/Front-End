      ...
      <div className="bg-[#5D5F5F] dark:bg-[#171717] p-8 sm:p-12 rounded-lg relative w-[320px] h-[570px] sm:w-[580px] sm:h-[660px] lg:w-[925px] lg:h-[700px] font-poppins">
        ...
        <div className="relative flex">
          ...
          <div className="px-3 sm:px-6 flex flex-col text-white">
            <h1 className="text-sm w-[120px] sm:w-[150px] sm:text-xl font-bold font-poppins text-white">{asset.videoName}</h1>
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const querySnapshot = await getDocs(collection(db, 'assetVideos')); // Ganti 'nama_koleksi' dengan nama koleksi di Firestore
        const items = [];
        ...
        // Susun data ke dalam format assets
          items.push({
            ...
            videoName: data.videoName,       // Nama dataset dari Firestore
            description: data.description,      // Deskripsi dataset dari Firestore
            price: `Rp. ${data.price}`,         // Harga dataset dari Firestore
            uploadUrlVideo: data.uploadUrlVideo,   // URL gambar dataset dari Firestore
          });
  ...
  return (
    <div className="bg-white dark:bg-[#212121]">
      ...
      <main className="bg-white dark:bg-[#212121] mt-36">
        <h1 className="bg-white dark:bg-[#212121] text-lg sm:text-xl font-semibold mt-6 mb-4 ml-4 sm:ml-16 font-roboto text-[#000000] dark:text-[#FFFFFF]">Asset Video</h1>
          ...
          {assets.map((asset, index) => (
            <div 
              ...
              <div className="text-sm">
                ...
                <h2 className="font-semibold mb-2 text-[#171717] dark:text-[#FFFFFF] truncate">{asset.videoName} - {asset.description}</h2>
