...
const PenjualanAsset = () => {
  ...
  const penjualanQuestions = [
    'Bagaimana cara menjual asset?',
    'Apa yang harus saya lakukan jika transaksi penjualan gagal?',
    'Berapa lama proses penjualan asset?',
    'Bagaimana cara mengatur harga jual?',
  ];
      ...
      <main className="bg-gray-100 py-10 px-5">
        <div className="max-w-md mx-auto mt-8">
          <div className="bg-white p-5 rounded-lg shadow-md">
            <h2 className="text-xl font-bold mb-4">Pertanyaan Penjualan Asset</h2>
            <ul className="space-y-2">
              {penjualanQuestions.map((question, index) => (
